package com.luz.andrade.cazarpatos
...
import com.luz.andrade.cazarpatos.database.RankingPlayerDBHelper
...
class RankingActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jugadores.add(Player("Luz.Andrade",15))
        jugadores.add(Player("Jugador2",14))
        jugadores.add(Player("Jugador3",11))
