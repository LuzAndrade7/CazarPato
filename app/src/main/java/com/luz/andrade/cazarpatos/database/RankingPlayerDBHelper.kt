package com.luz.andrade.cazarpatos.database
...
import com.luz.andrade.cazarpatos.Player
...
class RankingPlayerDBHelper(context: Context)
    ...
    fun insertRankingByQuery(player : Player){
        ...
        db.execSQL(sqlSentence) //PERMITE HACER crud ES GENERICO DEPENDE LO QUE DICE LA SENTENCIA, EN ESTE CASO INSERT
        db?.close()
    }
